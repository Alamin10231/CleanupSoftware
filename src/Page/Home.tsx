  ...
  const faqs = [
    {
      ...
      answer:
        "Our top influence service helps you reach a wider audience and boost engagement through verified influencers.",
    },
    {
      question: "Which is the Best Influence Service?",
      answer:
        "We provide personalized strategies to maximize your ROI with influencer marketing.",
    },
    {
      question: "Which is the Best Influence Service?",
      answer:
        "Our platform tracks results in real-time so you can see the impact of your campaigns instantly.",
    },
  ];
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ backgroundImage: `url(${assets.Color_Background_Image})` }}
      >
        {/* Nav */}
        ...
        <div className="container mx-auto px-10 flex justify-between items-center mt-25">
          <div>
            ...
            <h1 className="text-7xl font-bold text-gray-900 leading-tight mt-6">
              Professional Cleaning <br /> & Maintenance <br /> Services
            </h1>
      ...
      <div>
        ...
        <p className="text-center text-base pt-5">
          Select the services that match your lifestyle and property needs.
        </p>
        ...
        <div className="container mx-auto px-6 py-10">
          <div className="grid grid-cols-4 gap-6">
            <div>
              ...
              />
              <h3 className="text-xl font-semibold mt-3">Regular Cleaning</h3>
              <p className="text-base text-gray-400">
                Maintain a spotless environment with our routine cleaning services.
              </p>
            </div>
            <div>
              <img
                ...
                className="w-full h-48 object-cover rounded-xl"
              />
              <h3 className="text-xl font-semibold mt-3">Deep Cleaning</h3>
              <p className="text-base text-gray-400">
                Thorough cleaning for a fresh start, reaching every corner.
              </p>
            </div>
            <div>
              <img
                ...
                className="w-full h-48 object-cover rounded-xl"
              />
              <h3 className="text-xl font-semibold mt-3">Maintenance</h3>
              <p className="text-base text-gray-400">
                Keep your property in top shape with our comprehensive maintenance
                solutions.
              </p>
            </div>
            <div>
              <img
                ...
                className="w-full h-48 object-cover rounded-xl"
              />
              <h3 className="text-xl font-semibold mt-3">Landscaping</h3>
              <p className="text-base text-gray-400">
                Enhance your property's curb appeal with our professional landscaping.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6 mt-10 justify-items-center">
            <div>
              <img
                ...
                className="w-full h-48 object-cover rounded-xl"
              />
              <h3 className="text-xl font-semibold mt-3">Pest Control</h3>
              <p className="text-base text-gray-400">
                Protect your property from unwanted pests with our effective pest control.
              </p>
            </div>
            <div>
              <img
                ...
                className="w-full h-48 object-cover rounded-xl"
              />
              <h3 className="text-xl font-semibold mt-3">Security</h3>
              <p className="text-base text-gray-400">
                Ensure safety and peace of mind with our reliable security services.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="">
        <h1 className="text-4xl font-bold text-center mt-20">Need Help</h1>
        <p className="text-base text-gray-400 text-center mt-5">
          We are here to assist you. Contact our support team for any inquiries or assistance you may need.
        </p>
            ...
            {faqs.map((faq, index) => {
              ...
              return (
                <div key={index} className=" rounded-lg overflow-hidden shadow-sm">
                  ...
                  >
                    <p className="py-4 bg-white text-gray-600">{faq.answer}</p>
                  </div>
                </div>
              );
            })}
      ...
      <div className="mt-20 text-center bg-[rgba(36,99,234,0.2)] p-20 rounded-lg ">
        ...
        <p className="max-w-2xl mx-auto mt-4 text-gray-600">
          Furthermore, Lorem provides valuable insights into customer behavior and
          preferences. With analytics tools provided by social media platforms,
          businesses can take.
        </p>
        ...
        <div className="flex flex-col md:flex-row items-stretch mt-10 justify-center">
          ...
          <div className="relative bg-white p-6 shadow-md w-full md:w-[500px] h-[300px] flex flex-col justify-between text-left rounded-r-lg">
            ...
            {/* Client Info */}
            <div>
              <h3 className="text-xl font-semibold">Lana Bernier</h3>
              <p className="text-gray-500 text-sm">Senior Paradigm Strategist</p>
            </div>

            {/* Testimonial */}
            <p className="mt-4 text-gray-600 text-sm leading-relaxed flex-grow">
              Vestibulum ante ipsum primis in faucibus orci luctus et ultrices
              posuere cubilia Curae; Sed dignissim, velit eget consectetur commodo,
              justo velit consequat justo.
            </p>
