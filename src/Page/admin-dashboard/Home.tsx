    ...
    <div className="nunito">
          ...
          {user ? (
            <div className="flex gap-6">
              ...
              <button
                ...
                className="text-[#8241ED] border border-[#8241ED] px-4 py-2 cursor-pointer rounded-full hover:bg-[#8241ED] hover:text-white"
              >
                logout
        ...
        <div className="container mx-auto px-6 py-10">
          <div className="grid grid-cols-4 gap-6">
            <div>
              ...
              <p className="text-base text-gray-400">
                Maintain a spotless environment with our routine cleaning
                services.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-base text-gray-400">
                Keep your property in top shape with our comprehensive
            ...
            <div>
              ...
              <p className="text-base text-gray-400">
                Enhance your property's curb appeal with our professional
                landscaping.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6 mt-10 justify-items-center">
            <div>
              ...
              <p className="text-base text-gray-400">
                Protect your property from unwanted pests with our effective
                pest control.
              </p>
            </div>
            <div>
              ...
              <p className="text-base text-gray-400">
                Ensure safety and peace of mind with our reliable security
                services.
              </p>
            </div>
          </div>
      ...
      <div className="">
        ...
        <p className="text-base text-gray-400 text-center mt-5">
          We are here to assist you. Contact our support team for any inquiries
      ...
      <div className="mt-20 text-center bg-[rgba(36,99,234,0.2)] p-20 rounded-lg ">
        ...
        <p className="max-w-2xl mx-auto mt-4 text-gray-600">
          Furthermore, Lorem provides valuable insights into customer behavior
          and preferences. With analytics tools provided by social media
          platforms, businesses can take.
        </p>
        ...
        <div className="flex flex-col md:flex-row items-stretch mt-10 justify-center">
          ...
          <div className="relative bg-white p-6 shadow-md w-full md:w-[500px] h-[300px] flex flex-col justify-between text-left rounded-r-lg">
            ...
            <p className="mt-4 text-gray-600 text-sm leading-relaxed flex-grow">
              ...
              posuere cubilia Curae; Sed dignissim, velit eget consectetur
              commodo, justo velit consequat justo.
            </p>
