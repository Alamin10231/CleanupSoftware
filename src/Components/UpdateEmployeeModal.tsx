    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent>
        ...
        <div className="grid gap-4">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="is_on_leave" className="text-right">
              On Leave
            </Label>
            <select id="is_on_leave" value={isOnLeave.toString()} onChange={(e) => setIsOnLeave(e.target.value === 'true')} className="col-span-3">
        ...
        <div className="flex justify-end">
          ...
          <Button className="ml-2" onClick={handleUpdate}>Update</Button>
        </div>
      </DialogContent>
    </Dialog>
  );
